...
curl -vv -X GET --header 'Accept: application/json' --header 'X-ELS-APIKey:74c71d241426db269fba091507dfde38' 'https://api.elsevier.com/content/search/scopus?query=DOCTYPE("ar") AND (TITLE-ABS-KEY("benzylamine"))'

```

```bash
http --print HBh GET "https://api.elsevier.com/content/search/scopus?query=DOCTYPE("ar") AND (TITLE-ABS-KEY("benzylamine"))&count=1" Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38
# HTTP/1.1 200 OK

http --print HBh POST "https://api.elsevier.com/content/search/scopus?query=DOCTYPE("ar") AND (TITLE-ABS-KEY("benzylamine"))&count=1" Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38
# HTTP/1.1 200 OK

http --print HBh POST "https://api.elsevier.com/content/search/scopus" Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38 'query=DOCTYPE("ar") AND (TITLE-ABS-KEY("benzylamine"))'
# HTTP/1.1 400 Bad Request
# X-ELS-Status: INVALID_INPUT - Must provide search criteria using the query parameter.

http --print HBh POST "https://api.elsevier.com/content/search/scopus" Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38 'query=DOCTYPE(%22ar%22)%20AND%20(TITLE-ABS-KEY(%22benzylamine%22))'
# HTTP/1.1 400 Bad Request
# X-ELS-Status: INVALID_INPUT - Must provide search criteria using the query parameter.

http --print HBh POST "https://api.elsevier.com/content/search/scopus" Content-Type:application/json Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38 --raw 'query=DOCTYPE(%22ar%22)%20AND%20(TITLE-ABS-KEY(%22benzylamine%22))&count=1'
# HTTP/1.1 200 OK

http --print HBh POST "https://api.elsevier.com/content/search/scopus" Content-Type:text/html Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38 --raw 'query=DOCTYPE(%22ar%22)%20AND%20(TITLE-ABS-KEY(%22benzylamine%22))&count=1'
# HTTP/1.1 200 OK


http POST "https://api.elsevier.com/content/search/scopus" Content-Type:text/html Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38 --raw 'query=DOCTYPE("ar") AND (TITLE-ABS-KEY(benzylamine))&count=1'
# HTTP/1.1 200 OK

http POST "https://api.elsevier.com/content/search/scopus" Content-Type:application/json Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38 --raw 'query=DOCTYPE("ar") AND (TITLE-ABS-KEY(benzylamine))&count=1'
# HTTP/1.1 200 OK


http --print HBh POST "https://api.elsevier.com/content/search/scopus" Content-Type:text/html Accept:application/json X-ELS-APIKey:74c71d241426db269fba091507dfde38 @grand_total.txt
